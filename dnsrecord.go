...
type DNSRecord struct {
	...
	// AlternativeCNAMEDNSSEC is the alias pointing to this record in the DNSSEC-signed zone.
	// This is a read-only attribute generated by the API, empty when no signed alias exists.
	AlternativeCNAMEDNSSEC string `json:"alternativeCnameDnsSec,omitempty" jsonschema:"An alternative CNAME in the DNSSEC-signed zone pointing to this record. This is a read-only, server-generated value, empty when no signed alias exists."`
