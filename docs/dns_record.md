...
| `Endpoints` | map[string][]string | The Myra IP addresses serving this record, keyed by IP version (`ipv4`/`ipv6`). This attribute is generated by the API and cannot be set. It is returned for `A`, `AAAA` and `CNAME` records. |
