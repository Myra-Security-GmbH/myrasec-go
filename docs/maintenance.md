...
| `End` | string | End is a date type attribute with an `ISO 8601` format and shows the end date for a maintenance. This date have to be higher than start or null to end now. |
